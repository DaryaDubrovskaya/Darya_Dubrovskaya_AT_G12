...
public class TransportableProcessor {
    ...
    public void runTransportable(Transportable transportable, int pointA, int pointB) {
        ...
        System.out.printf("Transportable %s was moved to %d points", transportable.getClass().getSimpleName(), d);
    }
    ...
    public void runTransportable(Transportable transportable) {
        ...
        System.out.printf("Transportable %s was moved to %d points", transportable.getClass().getSimpleName(), g);
    }
